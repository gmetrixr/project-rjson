...
export enum ProjectProperty {
  ...
  product_card_share_url_template = "product_card_share_url_template",
  ...
  project_loading_banner_landscape = "project_loading_banner_landscape",
  project_loading_banner_portrait = "project_loading_banner_portrait",
...
export const projectPropertyDefaults:  Record<ProjectProperty, unknown> = {
  ...
  [ProjectProperty.product_card_share_url_template]: "{{{deployment_url}}}?scene_id={{scene_id}}&product_card_id={{product_card_id}}",
  ...
  [ProjectProperty.project_loading_banner_landscape]: undefined,
  [ProjectProperty.project_loading_banner_portrait]: undefined,

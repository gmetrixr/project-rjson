...
export enum ElementProperty {
  ...
  quiz_show_starting_screen = "quiz_show_starting_screen",
  quiz_show_ending_screen = "quiz_show_ending_screen",
  quiz_randomize_options = "quiz_randomize_options",
...
export const elementPropertyDefaults: Record<ElementProperty, unknown> = {
  ...
  [ElementProperty.quiz_show_starting_screen]: true,
  [ElementProperty.quiz_show_ending_screen]: true,
  [ElementProperty.quiz_randomize_options]: false,
